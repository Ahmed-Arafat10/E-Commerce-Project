...
// else if(check($name,strlen($name))){
//     $formerrors[] = 'Username contains Numbers';
// }
else{
    if(move_uploaded_file($image_temp,$location . $image_name)) echo "DONE";
    else echo "SHITTTTT";
$insert = "INSERT INTO customer VALUES(NULL,'$name','$password','$email','$address',$phone,'$image_name')";
...
<?php 
 ...
 ?>
    ...
    <div style="margin-left: 380px;margin-top:130px" class="container col-md-5 align-items-center">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" value="<?php echo $password ?>" class="form-control" placeholder="Enter Your Password Here">
            </div>
            <div class="form-group">
                <label for="">E-mail</label>
                <input type="email" name="email" value="<?php echo $email ?>" class="form-control" placeholder="Enter Your E-mail Here">
            </div>
            <div class="form-group">
                <label for="">Address</label>
                <input type="text" name="address" value="<?php echo $address ?>" class="form-control" placeholder="Enter Your Address Here">
            </div>
            <div class="form-group">
                <label for="">Phone</label>
                <input type="number" name="phone" value="<?php echo $phone ?>" class="form-control" placeholder="Enter Your Phone Number Here">
            </div>
            <div class="form-group">
           ...
           <?php if($update == false) : ?>
            <button type="submit" name="send_signup" class="btn btn-primary btn-lg btn-block" >Signup</button>
            <?php else:?>
